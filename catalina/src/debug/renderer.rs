...
impl DebugRenderer {
    pub fn new(
        ...
        let linesoup_points = engine.add_render_shader(
            device,
            "catalina.debug.linesoup_points",
            &module,
            "linepoints_vert",
            "sdf_circle_frag",
            wgpu::PrimitiveTopology::TriangleStrip,
        ...
        let unpaired_points = engine.add_render_shader(
            device,
            "catalina.debug.unpaired_points",
            &module,
            "linepoints_vert",
            "sdf_circle_frag",
            wgpu::PrimitiveTopology::TriangleStrip,
    ...
    pub fn render(
        ...
        let uniforms_buf = ResourceProxy::Buffer(
            recording.upload_uniform("catalina.debug_uniforms", bytemuck::bytes_of(&uniforms)),
        );
        ...
        let linepoints_uniforms_buf = recording.upload_uniform(
            "catalina.debug.linepoints_uniforms",
